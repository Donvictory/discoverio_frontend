  ...
  return (
    ...
    >
      ...
      <div className="sidebar-collapsed-icons">
        {/* Logo icon */}
        <span className="sidebar-collapsed-icons__logo" title="Discover.io">
          ✦
        </span>

        {/* New Chat */}
        <button
          className="sidebar-collapsed-icons__btn"
          onClick={onNewChat}
          title="New Chat"
        >
          <Plus size={20} />
        ...
        {/* Search */}
        <button className="sidebar-collapsed-icons__btn" title="Search">
          <Search size={20} />
        </button>

        {/* Spacer pushes user avatar to bottom */}
        <div className="sidebar-collapsed-icons__spacer" />

        {/* User avatar */}
        <button
          className="sidebar-collapsed-icons__btn sidebar-collapsed-icons__avatar"
          title="User"
        >
          U
        </button>
